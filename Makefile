...
N64LIB = -lultra_rom
CFLAGS := $(CFLAGS) -DNDEBUG -D_FINALROM -DF3DEX_GBI_2 -G 0 -MMD -MP -Iinclude -I. -I$(NUSYSINCDIR) -I$(NUSTDINCDIR) -I$(ROOT)/usr/include/PR -Wa,-Iinclude
...
$(CODESEGMENT):	$(CODEOBJPATH)
	...
	@$(LD) -o $(CODESEGMENT) -r $(CODEOBJPATH) $(NUSYSLIBDIR)/nusys.o $(LDFLAGS)
